...
if __name__ == "__main__":
    ...
    if datetime.now().weekday() >= 5:
        ...
        ALL_SYMBOLS = [
            ...
            ('bu0', '沥青'),('fu0', '燃料油'),('pg0', '液化气'),('sc0', '原油'),('jd0', '鸡蛋'),('sh0', '烧碱'),('ur0', '尿素'),('lg0', '原木'),('ss0', '不锈钢'),
            ('rb0', '螺纹钢'), ('hc0', '热卷'), ('au0', '黄金'), ('ag0', '白银'), ('cu0', '沪铜'), ('al0', '沪铝'),
            ('zn0', '沪锌'),('ni0', '沪镍'),('sp0', '纸浆'),('ru0', '橡胶'),('ao0', '氧化铝'),('sn0', '沪锡'),('pb0', '沪铅'),('ad0', '铝合金'),
            ('m0', '豆粕'),('rm0', '菜粕'), ('a0', '豆一'), ('b0', '豆二'),  ('i0', '铁矿石'), ('p0', '棕榈油'), ('y0', '豆油'),('oi0', '菜油'),  ('c0', '玉米'),('lh0', '生猪'),
            ('fg0', '玻璃'), ('sa0', '纯碱'), ('ma0', '甲醇'), ('ta0', 'PTA'),('px0', '对二甲苯'), ('pr0', '瓶片'), ('eb0', '苯乙烯'), ('eg0', '乙二醇'), ('v0', 'PVC'), ('l0', '塑料'),  ('sr0', '白糖'), ('cf0', '棉花'), ('ap0', '苹果'),('pk0', '花生'),
