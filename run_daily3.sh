...
run_step 10 10 "更新全市场股票ETF前复权价格" "update_stock_price_qfq.py" "--date" "latest" "--lookback-days" "420" "--symbols" "510050.SH,510300.SH,510500.SH,159915.SZ,588000.SH" "--portfolio-id" "official_cn_a_etf_v3" "--v3-daily-candidates" "--all-stock-price-symbols" "--asset-scope" "stock_etf" "--only-missing-or-stale" "--sleep-sec" "0.05"
