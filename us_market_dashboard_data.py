...
UNDERLYING_PROFILE_CARDS = {
    ...
    "ADBE": {
        "asset_type": "stock",
        "business": "Adobe 提供创意软件、文档云和营销数据平台。",
        "strength": "创意工具生态粘性强，AI 功能商业化可提升订阅价值。",
        "risk": "生成式 AI 竞争、企业软件预算和反垄断审查会影响估值。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "AMD": {
        "asset_type": "stock",
    ...
    "APP": {
        "asset_type": "stock",
        "business": "AppLovin 提供移动广告技术、应用变现和广告投放平台。",
        "strength": "AI 广告模型带来变现效率提升，业绩弹性和市场关注度高。",
        "risk": "广告周期、平台政策、增长持续性和高估值预期会放大波动。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "ARM": {
        "asset_type": "stock",
    ...
    "BA": {
        "asset_type": "stock",
        "business": "波音生产商用飞机、防务系统和航天产品。",
        "strength": "全球大型飞机寡头之一，订单周期长，航空复苏时收入弹性明显。",
        "risk": "交付质量、监管审查、供应链和现金流修复节奏是核心风险。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "BABA": {
        "asset_type": "stock",
    ...
    "C": {
        "asset_type": "stock",
        "business": "花旗提供全球银行、交易、财富管理和企业金融服务。",
        "strength": "全球业务覆盖广，重组和资本回报改善时估值修复空间较大。",
        "risk": "海外敞口、监管整改、信用周期和收益率曲线会影响盈利。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "CAT": {
        "asset_type": "stock",
        "business": "卡特彼勒生产工程机械、矿山设备、发动机和能源动力设备。",
        "strength": "工业周期代表性强，基建、矿业和能源投资改善时弹性明显。",
        "risk": "全球资本开支、商品周期、美元和库存周期会影响订单。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "COIN": {
        "asset_type": "stock",
    ...
    "CRM": {
        "asset_type": "stock",
        "business": "Salesforce 提供 CRM、企业应用、数据云和 AI Agent 平台。",
        "strength": "企业客户基础深，订阅收入稳定，AI 工具可提升客单价。",
        "risk": "企业软件预算、AI 变现节奏和并购整合会影响增长预期。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "CRWD": {
        "asset_type": "stock",
    ...
    "CVNA": {
        "asset_type": "stock",
        "business": "Carvana 经营线上二手车零售、融资和车辆交付服务。",
        "strength": "经营杠杆和空头关注度高，利润改善时股价弹性大。",
        "risk": "二手车价格、融资成本、债务结构和消费信贷周期会放大波动。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "DELL": {
        "asset_type": "stock",
    ...
    "EEM": {
        "asset_type": "etf",
        "business": "新兴市场 ETF，覆盖中国、台湾、印度等主要新兴市场股票。",
        "strength": "适合观察美元、全球流动性和新兴市场风险偏好。",
        "risk": "受美元利率、地缘风险、资本流动和地区政策影响较大。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "F": {
        "asset_type": "stock",
        "business": "福特生产燃油车、电动车、商用车并提供汽车金融服务。",
        "strength": "皮卡和商用车品牌强，低价股票期权成交活跃。",
        "risk": "汽车周期、劳工成本、EV 投入和信贷损失会影响利润。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "FXI": {
        "asset_type": "etf",
        "business": "中国大盘 ETF，覆盖港股上市的中国大型互联网、金融和消费公司。",
        "strength": "是观察中国政策预期、中概情绪和海外资金风险偏好的常用工具。",
        "risk": "政策、地产信用、汇率和中美关系变化会放大波动。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "GME": {
        "asset_type": "stock",
        "business": "游戏驿站经营游戏零售、电商和相关收藏品业务。",
        "strength": "散户关注度高，期权和空头情绪变化常带来剧烈波动。",
        "risk": "基本面转型不确定，股价容易受社群情绪和流动性冲击影响。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "GLD": {
        "asset_type": "etf",
    ...
    "IBM": {
        "asset_type": "stock",
        "business": "IBM 提供混合云、企业软件、咨询、主机和 AI 解决方案。",
        "strength": "企业客户关系深，Red Hat 与 AI 咨询推动软件和服务转型。",
        "risk": "咨询需求、美元、传统业务下滑和 AI 增长兑现节奏需关注。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "INTC": {
        "asset_type": "stock",
    ...
    "KRE": {
        "asset_type": "etf",
        "business": "区域银行 ETF，覆盖美国地方银行和中小银行。",
        "strength": "适合观察存款压力、商业地产风险和金融系统信用情绪。",
        "risk": "利率倒挂、存款流失、信用损失和监管资本要求会压制表现。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "LLY": {
        "asset_type": "stock",
        "business": "礼来研发和销售糖尿病、减重、肿瘤、免疫和神经科学药物。",
        "strength": "GLP-1 减重药和糖尿病产品带来长期成长空间。",
        "risk": "高估值、药价政策、产能爬坡和临床/监管事件需关注。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "MARA": {
        "asset_type": "stock",
    ...
    "PANW": {
        "asset_type": "stock",
        "business": "Palo Alto Networks 提供网络安全、防火墙、云安全和安全运营平台。",
        "strength": "安全平台化能力强，企业安全预算长期韧性较好。",
        "risk": "平台整合、销售周期、同业竞争和估值预期变化会影响波动。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "PDD": {
        "asset_type": "stock",
        "business": "拼多多经营中国电商和跨境平台 Temu。",
        "strength": "低价心智和跨境增长带来收入弹性，市场关注度高。",
        "risk": "平台监管、竞争补贴、跨境政策和利润率可持续性需跟踪。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "PFE": {
        "asset_type": "stock",
        "business": "辉瑞研发和销售疫苗、肿瘤、免疫、心血管和罕见病药物。",
        "strength": "产品组合和研发管线较广，现金流和股息属性明显。",
        "risk": "专利悬崖、药价政策、管线兑现和并购整合影响估值。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "PLTR": {
        "asset_type": "stock",
    ...
    "PYPL": {
        "asset_type": "stock",
        "business": "PayPal 提供线上支付、商户收单、Venmo 和数字钱包服务。",
        "strength": "支付网络和用户基础大，利润率修复时估值弹性明显。",
        "risk": "支付竞争、交易费率压力、消费周期和产品创新速度是主要风险。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "QCOM": {
        "asset_type": "stock",
    ...
    "SHOP": {
        "asset_type": "stock",
        "business": "Shopify 提供商户建站、支付、履约和电商运营工具。",
        "strength": "商户生态广，电商渗透和支付附加服务带来成长弹性。",
        "risk": "消费周期、竞争、利润率投入和高估值预期会放大波动。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "SLV": {
        "asset_type": "etf",
    ...
    "SMH": {
        "asset_type": "etf",
        "business": "半导体 ETF，覆盖全球芯片设计、制造、设备和封测龙头。",
        "strength": "适合观察 AI、先进制程和半导体景气的整体风险偏好。",
        "risk": "半导体周期、出口管制、资本开支和龙头集中度会影响波动。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "SNOW": {
        "asset_type": "stock",
        "business": "Snowflake 提供云数据仓库、数据共享、数据应用和 AI 数据平台。",
        "strength": "跨云数据平台定位清晰，AI 训练和企业数据治理提升需求。",
        "risk": "云数据竞争、消费型收入波动、利润率投入和估值预期较敏感。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "SOFI": {
        "asset_type": "stock",
    ...
    "UNH": {
        "asset_type": "stock",
        "business": "联合健康覆盖医疗保险、医疗服务和药房福利管理。",
        "strength": "规模和垂直整合能力强，是医疗保险板块核心代表。",
        "risk": "医疗成本率、医保政策、监管调查和赔付趋势会影响估值。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "USO": {
        "asset_type": "etf",
        "business": "原油 ETF，跟踪近月原油期货，是油价和通胀预期交易工具。",
        "strength": "适合观察能源冲击、地缘风险和通胀交易。",
        "risk": "期货展期、油价供需和地缘消息会带来较大波动。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "VRT": {
        "asset_type": "stock",
        "business": "Vertiv 提供数据中心电力、散热、机柜和基础设施解决方案。",
        "strength": "AI 数据中心建设带来电力和液冷需求，订单景气度较高。",
        "risk": "数据中心资本开支、供应链、项目交付和估值预期会影响波动。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "WMT": {
        "asset_type": "stock",
    ...
    "WFC": {
        "asset_type": "stock",
        "business": "富国银行提供零售银行、商业银行、房贷和财富管理服务。",
        "strength": "美国本土存贷款基础深，效率改善和监管解除有估值弹性。",
        "risk": "监管限制、信用成本、房贷业务和利率路径是主要变量。",
        "next_earnings_date": STOCK_EARNINGS_NOTE,
    },
    "XBI": {
        "asset_type": "etf",
        "business": "生物科技 ETF，覆盖美国中小型生物医药和创新药公司。",
        "strength": "对降息、并购、临床数据和风险偏好变化反应灵敏。",
        "risk": "临床失败、融资环境、监管审批和行业风险偏好会放大波动。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "XLE": {
        "asset_type": "etf",
    ...
    "XLI": {
        "asset_type": "etf",
        "business": "工业板块 ETF，覆盖机械、航空航天、运输和工业服务公司。",
        "strength": "适合观察制造业、基建、国防订单和经济周期预期。",
        "risk": "经济放缓、订单周期、美元和供应链成本会影响表现。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "XLK": {
        "asset_type": "etf",
        "business": "科技板块 ETF，覆盖美国大型软件、硬件和半导体公司。",
        "strength": "适合观察科技龙头、AI 投资和高成长风险偏好。",
        "risk": "估值、利率、AI 资本开支和龙头集中度会影响波动。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "XLV": {
        "asset_type": "etf",
        "business": "医疗保健 ETF，覆盖制药、医疗设备、保险和医疗服务公司。",
        "strength": "防御属性较强，适合观察医疗政策和大型药企景气。",
        "risk": "药价政策、医保监管、专利到期和临床事件会影响表现。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
    "XLY": {
        "asset_type": "etf",
        "business": "非必需消费 ETF，覆盖电商、汽车、零售和消费服务龙头。",
        "strength": "适合观察美国消费韧性、就业收入和风险偏好。",
        "risk": "利率、就业、消费者信心和龙头权重集中会放大波动。",
        "next_earnings_date": ETF_EARNINGS_NOTE,
    },
}
