...
FUTURES_GROUPS = {
    ...
    '工业': ['FG', 'SA', 'AO', 'SH', 'AD', 'RU', 'BR'],
    '能源': ['SC', 'FU', 'PG', 'LU', 'BU'],
    '化工': ['TA', 'MA', 'EG','EB', 'PP', 'L', 'V'],
    '农产品': ['M', 'Y', 'P', 'OI', 'RM','LH','UR','SR', 'CF', 'C', 'CS', 'AP', 'CJ', 'JD'],
}
...
FUTURES_NAMES = {
    ...
    # 工业
    'FG': '玻璃', 'SA': '纯碱', 'AO': '氧化铝', 'SH': '烧碱','AD': '铝合金', 'RU': '橡胶', 'BR': 'BR橡胶',
    # 能源
    'SC': '原油', 'FU': '燃油', 'PG': '液化气', 'LU': '低硫燃油','BU': '沥青',
    # 化工
    'TA': 'PTA', 'MA': '甲醇', 'EG': '乙二醇', 'EB': '苯乙烯','PP': '聚丙烯', 'L': '塑料', 'V': 'PVC',
    # 农产品
