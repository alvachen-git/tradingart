...
def process_ai_query(
    ...
    try:
        ...
        inputs = {
            ...
            "focus_topic": str(context_payload.get("focus_topic", "")),
            "focus_aspect": str(context_payload.get("focus_aspect", "")),
            "focus_mode_hint": str(context_payload.get("focus_mode_hint", "")),
            "followup_goal": str(context_payload.get("followup_goal", "")),
            "followup_action_context": str(context_payload.get("followup_action_context", "")),
            "followup_task_policy": context_payload.get("followup_task_policy") or {},
            "followup_route_context": str(context_payload.get("followup_route_context", "")),
