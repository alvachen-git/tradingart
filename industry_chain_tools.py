...
AI_CHAIN_DYNAMIC_RULES: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    "新能源": {
        "up_resource_material": {
            "include_keywords": ["锂电池概念", "盐湖提锂", "固态电池", "钠离子电池", "钒电池"],
            "exclude_keywords": ["新能源汽车", "充电桩", "光伏概念"],
            "company_include_keywords": ["锂矿", "碳酸锂", "磷酸铁锂", "三元材料", "电解液", "隔膜", "负极", "正极", "锂电"],
            "company_exclude_keywords": ["整车", "充电桩", "逆变器"],
            "whitelist_codes": ["885710.TI", "885922.TI", "886032.TI", "885928.TI", "886003.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "up_power_chip_control": {
            "include_keywords": ["汽车芯片", "汽车电子"],
            "exclude_keywords": ["锂电池概念", "新能源汽车", "光伏概念"],
            "company_include_keywords": ["IGBT", "SiC", "功率半导体", "BMS", "MCU", "汽车芯片", "汽车电子", "电控"],
            "company_exclude_keywords": ["电芯", "PACK", "光伏组件", "整车制造"],
            "whitelist_codes": ["885945.TI", "885545.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "mid_battery_cell_pack": {
            "include_keywords": ["锂电池概念", "固态电池", "钠离子电池", "钒电池"],
            "exclude_keywords": ["新能源汽车", "光伏概念", "商业航天"],
            "company_include_keywords": ["动力电池", "电芯", "模组", "PACK", "电池系统", "固态电池", "钠离子电池"],
            "company_exclude_keywords": ["逆变器", "火箭", "光伏"],
            "whitelist_codes": ["885710.TI", "886032.TI", "885928.TI", "886003.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "mid_electric_drive_thermal": {
            "include_keywords": ["汽车热管理", "汽车电子"],
            "exclude_keywords": ["盐湖提锂", "充电桩", "光伏概念"],
            "company_include_keywords": ["电驱", "电机", "电控", "减速器", "热管理", "高压系统", "汽车电子"],
            "company_exclude_keywords": ["锂矿", "电芯", "充电运营"],
            "whitelist_codes": ["885999.TI", "885545.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "mid_vehicle_oem": {
            "include_keywords": ["新能源汽车", "华为汽车", "小米汽车", "长安汽车概念"],
            "exclude_keywords": ["锂电池概念", "充电桩", "光伏概念"],
            "company_include_keywords": ["新能源整车", "乘用车", "商用车", "整车制造", "汽车整车", "新能源汽车"],
            "company_exclude_keywords": ["电池材料", "充电桩运营", "光伏电站"],
            "whitelist_codes": ["885431.TI", "885834.TI", "886064.TI", "886061.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "down_charge_operation_recycle": {
            "include_keywords": ["充电桩", "无线充电", "动力电池回收", "汽车拆解概念"],
            "exclude_keywords": ["整车制造", "锂矿", "电芯制造"],
            "company_include_keywords": ["充电桩", "换电", "回收", "梯次利用", "运营服务", "无线充电", "汽车拆解"],
            "company_exclude_keywords": ["整车制造", "锂矿", "电芯制造"],
            "whitelist_codes": ["885461.TI", "885774.TI", "885944.TI", "885902.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
    ...
    "光伏": {
        "up_silicon_aux": {
            "include_keywords": ["硅能源", "有机硅概念", "光伏概念"],
            "exclude_keywords": ["新能源汽车", "商业航天"],
            "company_include_keywords": ["工业硅", "多晶硅", "硅料", "银浆", "胶膜", "背板", "光伏玻璃", "辅材"],
            "company_exclude_keywords": ["逆变器", "电站运营", "储能运营"],
            "whitelist_codes": ["885958.TI", "885912.TI", "885531.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "up_wafer_cell": {
            "include_keywords": ["TOPCON电池", "HJT电池", "BC电池", "钙钛矿电池"],
            "exclude_keywords": ["组件EPC", "运维", "充电桩"],
            "company_include_keywords": ["硅片", "拉晶", "切片", "电池片", "TOPCon", "HJT", "PERC", "BC电池", "钙钛矿"],
            "company_exclude_keywords": ["组件EPC", "运维", "充电桩"],
            "whitelist_codes": ["886007.TI", "885878.TI", "886053.TI", "886006.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "mid_module": {
            "include_keywords": ["光伏概念", "光伏建筑一体化"],
            "exclude_keywords": ["风电", "储能电池", "卫星终端"],
            "company_include_keywords": ["光伏组件", "组件封装", "组件制造"],
            "company_exclude_keywords": ["风电", "储能电池", "卫星终端"],
            "whitelist_codes": ["885531.TI", "885920.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "mid_inverter_electrical": {
            "include_keywords": ["光伏概念", "光伏建筑一体化", "储能"],
            "exclude_keywords": ["新能源汽车", "商业航天"],
            "company_include_keywords": ["逆变器", "汇流箱", "光伏电气", "并网设备", "组串逆变", "微逆"],
            "company_exclude_keywords": ["储能PCS", "风电变流器", "电站运营"],
            "whitelist_codes": ["885531.TI", "885920.TI", "885921.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "mid_system_epc": {
            "include_keywords": ["光伏建筑一体化", "光伏概念"],
            "exclude_keywords": ["储能运营", "风电运营", "逆变器制造"],
            "company_include_keywords": ["系统集成", "EPC", "BOS", "工程建设", "光伏工程", "电站建设"],
            "company_exclude_keywords": ["储能运营", "风电运营", "逆变器制造"],
            "whitelist_codes": ["885920.TI", "885531.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
        },
        "down_plant_operation": {
            "include_keywords": ["光伏概念", "光伏建筑一体化"],
            "exclude_keywords": ["新能源汽车", "商业航天"],
            "company_include_keywords": ["光伏电站", "电站运维", "电站运营", "分布式光伏", "集中式光伏", "新能源发电"],
            "company_exclude_keywords": ["风电运营", "电池片制造", "逆变器制造"],
            "whitelist_codes": ["885531.TI", "885920.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 10,
            "company_keep_max_stages": 2,
    ...
    "航天卫星": {
        "up_aero_material_elec": {
            "include_keywords": ["军工", "军工信息化", "商业航天"],
            "exclude_keywords": ["光伏概念", "新能源汽车"],
            "company_include_keywords": ["航天材料", "特种电子", "射频器件", "导航器件", "电源模块", "军工电子"],
            "company_exclude_keywords": ["终端运营", "整车制造"],
            "whitelist_codes": ["885700.TI", "886076.TI", "886078.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 6,
            "company_keep_max_stages": 2,
        },
        "up_payload_platform_parts": {
            "include_keywords": ["商业航天", "卫星导航", "军工"],
            "exclude_keywords": ["光伏概念", "新能源汽车"],
            "company_include_keywords": ["卫星平台", "卫星载荷", "姿轨控", "推进系统", "结构件", "航天器"],
            "company_exclude_keywords": ["地面站运营", "终端运营"],
            "whitelist_codes": ["886078.TI", "885574.TI", "885700.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 6,
            "company_keep_max_stages": 2,
        },
        "mid_satellite_launch": {
            "include_keywords": ["商业航天", "军工"],
            "exclude_keywords": ["光伏概念", "新能源汽车"],
            "company_include_keywords": ["卫星总装", "火箭发射", "发射服务", "商业火箭", "发射场", "总装测试"],
            "company_exclude_keywords": ["终端应用", "地面终端", "互联网运营"],
            "whitelist_codes": ["886078.TI", "885700.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 6,
            "company_keep_max_stages": 2,
        },
        "mid_ground_tt_c": {
            "include_keywords": ["卫星导航", "军工信息化"],
            "exclude_keywords": ["光伏概念", "新能源汽车"],
            "company_include_keywords": ["地面站", "测控", "运控", "测运控", "网络调度", "导航系统"],
            "company_exclude_keywords": ["整车", "地面武器"],
            "whitelist_codes": ["885574.TI", "886076.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 6,
            "company_keep_max_stages": 2,
        },
        "mid_terminal_module": {
            "include_keywords": ["卫星导航", "商业航天"],
            "exclude_keywords": ["光伏概念", "新能源汽车"],
            "company_include_keywords": ["卫星终端", "通信模组", "卫星天线", "接入终端", "北斗终端", "导航终端"],
            "company_exclude_keywords": ["火箭制造", "整星总装"],
            "whitelist_codes": ["885574.TI", "886078.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 6,
            "company_keep_max_stages": 2,
        },
        "down_satcom_operation_app": {
            "include_keywords": ["卫星导航", "商业航天", "军工信息化"],
            "exclude_keywords": ["光伏概念", "新能源汽车"],
            "company_include_keywords": ["卫星互联网", "卫星通信运营", "卫星应用", "数据服务", "行业应用", "导航运营"],
            "company_exclude_keywords": ["纯制造", "火箭制造", "卫星零部件"],
            "whitelist_codes": ["885574.TI", "886078.TI", "886076.TI"],
            "max_index_codes": 6,
            "min_companies_before_fallback": 6,
            "company_keep_max_stages": 2,
        },
...
AI_CHAIN_DYNAMIC_RULES.update(
    {
        "机器人": {
            "up_core_parts": {
                "include_keywords": ["机器人", "减速器", "伺服", "控制器", "谐波减速器"],
                "exclude_keywords": ["医药", "航天", "光伏"],
                "company_include_keywords": ["减速器", "伺服", "控制器", "谐波", "RV减速器", "执行器"],
                "company_exclude_keywords": ["整车", "电池回收", "火箭"],
                "whitelist_codes": ["885975.TI", "885545.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "up_sensor_control": {
                "include_keywords": ["机器视觉", "传感器", "工业自动化", "控制系统"],
                "exclude_keywords": ["创新药", "光伏", "卫星"],
                "company_include_keywords": ["机器视觉", "力矩传感", "编码器", "视觉传感", "控制系统", "导航控制"],
                "company_exclude_keywords": ["原料药", "火箭", "电站运营"],
                "whitelist_codes": ["885603.TI", "885806.TI", "885545.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_robot_body": {
                "include_keywords": ["机器人", "工业机器人", "协作机器人", "人形机器人"],
                "exclude_keywords": ["医药", "卫星导航", "锂矿"],
                "company_include_keywords": ["工业机器人", "协作机器人", "人形机器人", "机器人本体", "机械臂"],
                "company_exclude_keywords": ["原料药", "卫星终端", "锂矿"],
                "whitelist_codes": ["885975.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_system_integration": {
                "include_keywords": ["智能制造", "自动化设备", "系统集成", "产线自动化"],
                "exclude_keywords": ["创新药", "航天", "光伏电站"],
                "company_include_keywords": ["系统集成", "产线自动化", "机器人集成", "智能工厂", "自动化产线"],
                "company_exclude_keywords": ["原料药", "卫星发射", "电站运营"],
                "whitelist_codes": ["885603.TI", "885806.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_embodied_software": {
                "include_keywords": ["人工智能", "机器视觉", "工业软件", "机器人"],
                "exclude_keywords": ["锂电池", "医药商业", "火箭"],
                "company_include_keywords": ["具身智能", "运动控制", "算法平台", "视觉算法", "机器人软件"],
                "company_exclude_keywords": ["动力电池", "医药流通", "火箭发射"],
                "whitelist_codes": ["885728.TI", "885603.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "down_industry_service": {
                "include_keywords": ["智能制造", "物流", "商业服务机器人", "无人配送"],
                "exclude_keywords": ["卫星互联网", "医药原料", "光伏玻璃"],
                "company_include_keywords": ["工业场景", "物流场景", "商业服务", "运维服务", "机器人应用"],
                "company_exclude_keywords": ["卫星运营", "原料药", "光伏辅材"],
                "whitelist_codes": ["881121.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
        ...
        "储能": {
            "up_storage_material": {
                "include_keywords": ["储能", "锂电池", "钠离子电池", "固态电池", "电解液", "隔膜"],
                "exclude_keywords": ["整车", "航空航天", "创新药"],
                "company_include_keywords": ["储能材料", "电解液", "隔膜", "正极", "负极", "锂电材料"],
                "company_exclude_keywords": ["整车制造", "火箭", "原料药"],
                "whitelist_codes": ["885921.TI", "885710.TI", "885922.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "up_power_semiconductor": {
                "include_keywords": ["储能", "功率半导体", "IGBT", "SiC", "电力电子"],
                "exclude_keywords": ["医药", "卫星", "整车"],
                "company_include_keywords": ["IGBT", "SiC", "功率器件", "控制芯片", "BMS", "MCU"],
                "company_exclude_keywords": ["原料药", "卫星通信", "整车制造"],
                "whitelist_codes": ["885945.TI", "885545.TI", "885921.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_cell_pack": {
                "include_keywords": ["储能", "锂电池", "钠离子电池", "固态电池"],
                "exclude_keywords": ["光伏EPC", "卫星导航", "创新药"],
                "company_include_keywords": ["储能电芯", "PACK", "模组", "电池系统", "电芯制造"],
                "company_exclude_keywords": ["卫星终端", "原料药", "光伏工程"],
                "whitelist_codes": ["885921.TI", "885710.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_pcs_bms_ems": {
                "include_keywords": ["储能", "逆变器", "PCS", "BMS", "EMS"],
                "exclude_keywords": ["整车", "医药商业", "航天"],
                "company_include_keywords": ["PCS", "BMS", "EMS", "储能变流器", "能量管理系统"],
                "company_exclude_keywords": ["整车", "医药流通", "火箭"],
                "whitelist_codes": ["885921.TI", "885920.TI", "885531.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_system_integrator": {
                "include_keywords": ["储能", "系统集成", "电站系统", "微电网", "虚拟电厂"],
                "exclude_keywords": ["创新药", "卫星", "机器人本体"],
                "company_include_keywords": ["储能系统集成", "微电网", "虚拟电厂", "系统集成", "项目交付"],
                "company_exclude_keywords": ["原料药", "卫星发射", "机器人本体"],
                "whitelist_codes": ["885921.TI", "885920.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "down_station_operation": {
                "include_keywords": ["储能", "电站运营", "运维", "能源服务", "虚拟电厂"],
                "exclude_keywords": ["锂矿", "芯片设计", "卫星"],
                "company_include_keywords": ["储能电站", "电站运营", "运维服务", "调频服务", "能源运营"],
                "company_exclude_keywords": ["锂矿", "芯片设计", "卫星终端"],
                "whitelist_codes": ["885921.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
        ...
        "工业母机": {
            "up_material_casting": {
                "include_keywords": ["工业母机", "特钢", "铸件", "机床"],
                "exclude_keywords": ["创新药", "光伏", "低空经济"],
                "company_include_keywords": ["铸件", "特种钢材", "机床材料", "基础件"],
                "company_exclude_keywords": ["原料药", "光伏组件", "无人机整机"],
                "whitelist_codes": ["885806.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "up_core_components": {
                "include_keywords": ["工业母机", "数控系统", "主轴", "丝杠", "导轨", "机床"],
                "exclude_keywords": ["创新药", "卫星", "电站运营"],
                "company_include_keywords": ["数控系统", "主轴", "滚珠丝杠", "导轨", "伺服驱动", "核心部件"],
                "company_exclude_keywords": ["原料药", "卫星终端", "电站运营"],
                "whitelist_codes": ["885806.TI", "885545.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_tools_fixture": {
                "include_keywords": ["工业母机", "刀具", "夹具", "测量", "精密工具"],
                "exclude_keywords": ["创新药", "新能源整车", "商业航天"],
                "company_include_keywords": ["刀具", "夹具", "量具", "测量仪器", "机床附件"],
                "company_exclude_keywords": ["原料药", "整车制造", "火箭"],
                "whitelist_codes": ["885806.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            ...
            "mid_machine_tool": {
                "include_keywords": ["工业母机", "机床", "数控机床", "高端装备"],
                "exclude_keywords": ["创新药", "卫星互联网", "储能运营"],
                "company_include_keywords": ["机床整机", "数控机床", "高端机床", "加工中心"],
                "company_exclude_keywords": ["原料药", "卫星运营", "储能电站"],
                "whitelist_codes": ["885806.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_line_integration": {
                "include_keywords": ["智能制造", "自动化产线", "工业自动化", "工业母机"],
                "exclude_keywords": ["创新药", "低空经济", "光伏电站"],
                "company_include_keywords": ["产线集成", "自动化产线", "智能工厂", "工业自动化"],
                "company_exclude_keywords": ["原料药", "无人机运营", "光伏电站"],
                "whitelist_codes": ["885603.TI", "885806.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "down_industry_application": {
                "include_keywords": ["高端制造", "汽车制造", "航空制造", "工业服务"],
                "exclude_keywords": ["创新药", "卫星应用", "储能材料"],
                "company_include_keywords": ["制造应用", "后市场服务", "维保服务", "行业应用"],
                "company_exclude_keywords": ["原料药", "卫星终端", "储能材料"],
                "whitelist_codes": ["881121.TI", "885603.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
        ...
        "创新药": {
            "up_reagent_intermediate": {
                "include_keywords": ["创新药", "原料药", "中间体", "医药化工", "生物试剂"],
                "exclude_keywords": ["医疗器械", "机器人", "低空经济"],
                "company_include_keywords": ["中间体", "原料药", "医药试剂", "特色原料", "化学原料药"],
                "company_exclude_keywords": ["医疗器械", "机器人本体", "无人机"],
                "whitelist_codes": ["885878.TI", "885817.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "up_bio_equipment_consumables": {
                "include_keywords": [
                    "创新药",
                    "生物医药",
                    "医药设备",
                ...
                "company_exclude_keywords": ["医院服务", "机器人", "卫星"],
                "whitelist_codes": ["885817.TI", "885878.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            },
            "mid_cxo_service": {
                "include_keywords": ["CRO", "CDMO", "CMO", "CXO", "创新药"],
                "exclude_keywords": ["医疗器械", "光伏", "新能源"],
                "company_include_keywords": ["CRO", "CDMO", "CMO", "CXO", "研发服务", "外包服务"],
                "company_exclude_keywords": ["器械销售", "光伏", "整车"],
                "whitelist_codes": ["886016.TI", "885817.TI", "885878.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "mid_innovative_pharma": {
                "include_keywords": ["创新药", "生物医药", "抗体药", "小分子新药", "细胞治疗"],
                "exclude_keywords": ["医疗服务", "光伏", "机器人"],
                "company_include_keywords": ["创新药", "抗体药物", "小分子新药", "细胞治疗", "研发管线"],
                "company_exclude_keywords": ["医院运营", "光伏", "机器人本体"],
                "whitelist_codes": ["885817.TI", "885878.TI", "886016.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "mid_registration_commercial": {
                "include_keywords": ["创新药", "药品注册", "医药商业化", "药品推广"],
                "exclude_keywords": ["医疗器械", "机器人", "航天"],
                "company_include_keywords": ["注册申报", "商业化", "市场准入", "学术推广", "药品营销"],
                "company_exclude_keywords": ["器械销售", "机器人", "卫星"],
                "whitelist_codes": ["885817.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "down_channel_payment": {
                "include_keywords": ["医药商业", "DTP", "医保", "药店连锁", "创新药"],
                "exclude_keywords": ["医疗器械", "机器人", "低空经济"],
                "company_include_keywords": ["医药商业", "DTP", "渠道分销", "支付体系", "院外市场"],
                "company_exclude_keywords": ["器械制造", "机器人本体", "无人机"],
                "whitelist_codes": ["885817.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
        ...
        "低空经济": {
            "up_airframe_material": {
                "include_keywords": ["低空经济", "无人机", "航空材料", "复合材料", "碳纤维"],
                "exclude_keywords": ["创新药", "光伏", "储能"],
                "company_include_keywords": ["机体结构", "复合材料", "碳纤维", "航空结构件", "轻量化材料"],
                "company_exclude_keywords": ["原料药", "光伏组件", "储能运营"],
                "whitelist_codes": ["886078.TI", "885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            ...
            "up_power_avionics": {
                "include_keywords": ["低空经济", "无人机", "飞控", "导航", "航电", "北斗导航"],
                "exclude_keywords": ["创新药", "光伏", "医药商业"],
                "company_include_keywords": ["飞控", "导航", "航电", "通信链路", "动力系统", "北斗"],
                "company_exclude_keywords": ["原料药", "光伏电站", "医药流通"],
                "whitelist_codes": ["885574.TI", "886078.TI", "885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
            "mid_uav_evtol": {
                "include_keywords": ["低空经济", "无人机", "eVTOL", "飞行汽车", "通航装备"],
                "exclude_keywords": ["创新药", "光伏", "储能材料"],
                "company_include_keywords": [
                    "无人机",
                    "无人机整机",
                    "eVTOL",
                ...
                "company_exclude_keywords": ["原料药", "光伏", "储能材料"],
                "whitelist_codes": ["886078.TI", "885700.TI", "886076.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            ...
            "mid_ground_infra": {
                "include_keywords": ["低空经济", "空管", "地面站", "通航机场", "低空基础设施"],
                "exclude_keywords": ["创新药", "机器人", "锂矿"],
                "company_include_keywords": ["地面设施", "空管系统", "起降场", "测控系统", "通信基站"],
                "company_exclude_keywords": ["原料药", "机器人本体", "锂矿"],
                "whitelist_codes": ["885574.TI", "886076.TI", "886078.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
            "mid_operation_service": {
                "include_keywords": ["低空经济", "无人机运营", "巡检", "物流配送", "应急服务"],
                "exclude_keywords": ["创新药", "光伏", "卫星发射"],
                "company_include_keywords": ["运营服务", "物流配送", "巡检服务", "应急救援", "行业运营"],
                "company_exclude_keywords": ["原料药", "光伏电站", "卫星发射"],
                "whitelist_codes": ["886078.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
            "down_industry_apps": {
                "include_keywords": ["低空经济", "行业应用", "文旅低空", "农林植保", "城市管理"],
                "exclude_keywords": ["创新药", "光伏", "锂电池材料"],
                "company_include_keywords": ["行业应用", "商业场景", "政企场景", "巡检场景", "物流场景"],
                "company_exclude_keywords": ["原料药", "光伏组件", "锂矿"],
                "whitelist_codes": ["881121.TI", "886078.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
        ...
        "电力": {
            "up_generation_supply": {
                "include_keywords": ["电力", "火电", "水电", "风电设备", "发电设备", "能源供给"],
                "exclude_keywords": ["创新药", "无人机", "军工电子"],
                "company_include_keywords": ["发电设备", "锅炉", "汽轮机", "水轮机", "燃机", "能源供给", "风机"],
                "company_exclude_keywords": ["配电自动化", "电力交易", "虚拟电厂", "医药"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "up_transmission_primary": {
                "include_keywords": ["特高压", "输变电", "电网设备", "高压设备", "一次设备"],
                "exclude_keywords": ["创新药", "低空经济", "卫星互联网"],
                "company_include_keywords": ["特高压", "变压器", "开关设备", "一次设备", "输电", "电网设备"],
                "company_exclude_keywords": ["医药", "无人机", "卫星"],
                "whitelist_codes": [],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "mid_distribution_secondary": {
                "include_keywords": ["智能电网", "配电自动化", "二次设备", "继电保护", "电力自动化", "智能配电", "电力物联网"],
                "exclude_keywords": ["创新药", "军工整机", "有色采矿"],
                "company_include_keywords": ["智能电网", "配电自动化", "二次设备", "继电保护", "电力自动化", "智能配电", "配网", "电网自动化", "电力物联网"],
                "company_exclude_keywords": ["采矿", "原料药", "军工整机"],
                "whitelist_codes": ["885311.TI", "885425.TI", "886004.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            },
            "mid_dispatch_digital": {
                "include_keywords": ["智能电网", "电力物联网", "虚拟电厂", "电力信息化", "调度", "能源管理", "电网信息化", "电力数字化"],
                "exclude_keywords": ["创新药", "无人机整机", "军工材料"],
                "company_include_keywords": ["虚拟电厂", "电力交易", "调度系统", "电网信息化", "SCADA", "能源管理", "电力数字化", "调控平台", "电力物联网"],
                "company_exclude_keywords": ["原料药", "无人机整机", "军工材料"],
                "whitelist_codes": ["885311.TI", "886004.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            ...
            "mid_trading_vpp": {
                "include_keywords": ["电力交易", "虚拟电厂", "需求侧管理", "负荷聚合", "售电"],
                "exclude_keywords": ["创新药", "卫星发射", "有色冶炼"],
                "company_include_keywords": ["电力交易", "虚拟电厂", "售电", "需求响应", "负荷聚合", "能源服务"],
                "company_exclude_keywords": ["原料药", "卫星发射", "有色冶炼"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "down_demand_response": {
                "include_keywords": ["需求响应", "综合能源服务", "电力服务", "用电服务", "节能服务"],
                "exclude_keywords": ["创新药", "军工整机", "采矿"],
                "company_include_keywords": ["需求响应", "综合能源服务", "电力服务", "用电服务", "节能", "负荷管理"],
                "company_exclude_keywords": ["原料药", "军工整机", "采矿"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
        ...
        "核电": {
            "up_fuel_material": {
                "include_keywords": ["核电", "核能", "核燃料", "铀", "核材料"],
                "exclude_keywords": ["创新药", "机器人", "低空经济"],
                "company_include_keywords": ["核燃料", "铀", "锆材", "核材料", "核级材料", "燃料组件"],
                "company_exclude_keywords": ["原料药", "机器人本体", "无人机"],
                "whitelist_codes": ["885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
            "up_main_equipment_forging": {
                "include_keywords": ["核电", "核主设备", "锻件", "铸件", "压力容器"],
                "exclude_keywords": ["创新药", "卫星互联网", "光伏组件"],
                "company_include_keywords": ["核主设备", "核级泵阀", "锻件", "铸件", "压力容器", "蒸汽发生器"],
                "company_exclude_keywords": ["原料药", "卫星终端", "光伏组件"],
                "whitelist_codes": ["885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            ...
            "mid_island_system": {
                "include_keywords": ["核岛", "常规岛", "核电设备", "核电系统"],
                "exclude_keywords": ["创新药", "低空经济", "有色采矿"],
                "company_include_keywords": ["核岛", "常规岛", "核电系统", "核电设备", "核级阀门", "核级泵"],
                "company_exclude_keywords": ["原料药", "无人机", "采矿"],
                "whitelist_codes": ["885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
            "mid_epc_construction": {
                "include_keywords": ["核电", "EPC", "核电建设", "工程建设", "核工程"],
                "exclude_keywords": ["创新药", "机器人", "卫星通信"],
                "company_include_keywords": ["核电EPC", "核工程", "工程建设", "项目总包", "安装调试"],
                "company_exclude_keywords": ["原料药", "机器人本体", "卫星通信"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
            },
            "mid_operation_safety": {
                "include_keywords": ["核电", "核电运维", "核安全", "核电检修", "核技术服务", "核电站"],
                "exclude_keywords": ["创新药", "光伏玻璃", "卫星发射"],
                "company_include_keywords": ["核电", "核电运维", "核安全", "检修", "辐射监测", "安全服务", "核技术服务", "核电站运维", "发电运营"],
                "company_exclude_keywords": ["原料药", "光伏玻璃", "卫星发射"],
                "whitelist_codes": ["885571.TI", "885700.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            },
            "down_nuclear_generation": {
                "include_keywords": ["核电", "核能", "核电运营", "核电发电", "核电站", "清洁能源发电"],
                "exclude_keywords": ["创新药", "军工电子", "采矿"],
                "company_include_keywords": ["核电", "核能", "核电运营", "核电发电", "核电站", "发电运营", "清洁能源发电", "清洁能源"],
                "company_exclude_keywords": ["原料药", "军工电子", "采矿"],
                "whitelist_codes": ["885571.TI", "885700.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 6,
                "company_keep_max_stages": 2,
        ...
        "军工": {
            "up_special_material_parts": {
                "include_keywords": ["军工", "军工材料", "特种材料", "军工元器件", "国防军工"],
                "exclude_keywords": ["创新药", "光伏概念", "储能"],
                "company_include_keywords": ["特种材料", "军工材料", "军工元器件", "钛合金", "复材", "高温合金"],
                "company_exclude_keywords": ["原料药", "光伏组件", "储能电站"],
                "whitelist_codes": ["885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "up_military_electronics": {
                "include_keywords": ["军工电子", "雷达", "电子对抗", "军工信息化", "军工"],
                "exclude_keywords": ["创新药", "采矿", "光伏玻璃"],
                "company_include_keywords": ["军工电子", "雷达", "电子对抗", "导航", "通信链路", "军用芯片"],
                "company_exclude_keywords": ["原料药", "采矿", "光伏玻璃"],
                "whitelist_codes": ["886076.TI", "885700.TI", "885574.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_platform_equipment": {
                "include_keywords": ["军工", "航空装备", "船舶", "导弹", "整机平台"],
                "exclude_keywords": ["创新药", "机器人", "电站运营"],
                "company_include_keywords": ["整机平台", "航空装备", "舰船装备", "导弹装备", "武器系统", "总装"],
                "company_exclude_keywords": ["原料药", "机器人本体", "电站运营"],
                "whitelist_codes": ["885700.TI", "886078.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_command_info": {
                "include_keywords": ["军工信息化", "指挥控制", "C4ISR", "军用通信", "北斗导航"],
                "exclude_keywords": ["创新药", "有色冶炼", "光伏电站"],
                "company_include_keywords": ["指挥控制", "C4ISR", "军用通信", "态势感知", "导航定位", "作战系统"],
                "company_exclude_keywords": ["原料药", "有色冶炼", "光伏电站"],
                "whitelist_codes": ["886076.TI", "885574.TI", "885700.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "mid_test_maintenance": {
                "include_keywords": ["军工", "试验测试", "军工检测", "保障维护", "维修保障"],
                "exclude_keywords": ["创新药", "采矿", "卫星运营"],
                "company_include_keywords": ["试验测试", "检测", "保障维护", "维修保障", "可靠性验证", "军工服务"],
                "company_exclude_keywords": ["原料药", "采矿", "卫星运营"],
                "whitelist_codes": ["885700.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
            },
            "down_delivery_conversion": {
                "include_keywords": ["军民融合", "军工交付", "军工应用", "民用转化", "国防军工"],
                "exclude_keywords": ["创新药", "有色采矿", "光伏辅材"],
                "company_include_keywords": ["军民融合", "装备交付", "民用转化", "军工应用", "保障服务"],
                "company_exclude_keywords": ["原料药", "采矿", "光伏辅材"],
                "whitelist_codes": ["885700.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 8,
                "company_keep_max_stages": 2,
        ...
        "有色金属": {
            "up_mining_resource": {
                "include_keywords": ["有色金属", "铜", "铝", "锂矿", "镍", "钴", "稀土", "资源"],
                "exclude_keywords": ["创新药", "机器人", "卫星互联网"],
                "company_include_keywords": ["矿山", "采矿", "铜矿", "铝土矿", "锂矿", "镍矿", "钴矿", "稀土"],
                "company_exclude_keywords": ["原料药", "机器人本体", "卫星终端"],
                "whitelist_codes": [],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "up_smelting_refining": {
                "include_keywords": ["小金属", "金属铜", "金属锌", "金属铅", "金属镍", "金属钴", "有色冶炼", "电解铝", "铜冶炼", "精炼", "湿法冶金"],
                "exclude_keywords": ["创新药", "低空经济", "光伏电站"],
                "company_include_keywords": ["有色冶炼", "冶炼", "精炼", "电解铝", "铜冶炼", "湿法冶金", "火法冶金", "金属冶炼"],
                "company_exclude_keywords": ["原料药", "无人机", "光伏电站"],
                "whitelist_codes": ["885343.TI", "885865.TI", "885969.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            ...
            "mid_base_alloy": {
                "include_keywords": ["小金属", "金属铜", "金属锌", "金属铅", "金属镍", "金属钴", "稀土永磁", "有色加工", "合金", "铜加工", "铝加工", "金属材料", "有色金属"],
                "exclude_keywords": ["创新药", "卫星发射", "机器人本体"],
                "company_include_keywords": ["有色金属", "铜加工", "铝加工", "合金加工", "合金材料", "基础金属", "金属加工", "板带箔", "型材"],
                "company_exclude_keywords": ["原料药", "卫星发射", "机器人本体"],
                "whitelist_codes": ["885343.TI", "885865.TI", "885969.TI", "881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
                "stage_relevance_threshold": 0,
            },
            "mid_functional_material": {
                "include_keywords": ["功能材料", "高端金属材料", "磁性材料", "导电材料", "稀土永磁"],
                "exclude_keywords": ["创新药", "军工整机", "低空运营"],
                "company_include_keywords": ["功能材料", "磁性材料", "导电材料", "稀土永磁", "高端合金", "电子材料"],
                "company_exclude_keywords": ["原料药", "军工整机", "低空运营"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            },
            "mid_component_processing": {
                "include_keywords": ["金属部件", "型材加工", "精密加工", "结构件", "深加工"],
                "exclude_keywords": ["创新药", "卫星运营", "电站运营"],
                "company_include_keywords": ["型材", "结构件", "精密加工", "金属部件", "深加工", "零部件"],
                "company_exclude_keywords": ["原料药", "卫星运营", "电站运营"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
            ...
            "down_industry_application": {
                "include_keywords": ["有色应用", "新能源材料", "电力设备", "军工材料", "终端应用"],
                "exclude_keywords": ["创新药", "卫星发射", "无人机运营"],
                "company_include_keywords": ["新能源应用", "电力应用", "军工应用", "终端应用", "材料应用", "产业应用"],
                "company_exclude_keywords": ["原料药", "卫星发射", "无人机运营"],
                "whitelist_codes": ["881121.TI"],
                "max_index_codes": 6,
                "min_companies_before_fallback": 10,
                "company_keep_max_stages": 2,
...
def _fallback_extract_domain_tags(text_value: str) -> List[str]:
    ...
    mapping = [
        ...
        ("工业控制", ["工业控制", "工控", "自动化"]),
        ("AI算力", ["ai", "算力", "服务器", "数据中心"]),
        ("新能源", ["新能源", "动力电池", "电芯", "充电桩", "换电"]),
        ("光伏", ["光伏", "电池片", "组件", "逆变器", "电站"]),
        ("航天卫星", ["航天", "卫星", "火箭", "测控", "卫星通信"]),
    ]
