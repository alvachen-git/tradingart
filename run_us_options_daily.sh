...
US_OPTIONS_UNDERLYINGS="${US_OPTIONS_UNDERLYINGS:-SPY,QQQ,DIA,IWM,AAPL,AMD,AMZN,ARM,ASML,AVGO,BA,BABA,BAC,COIN,CRWD,CVNA,DELL,DIS,DRAM,EEM,F,FXI,GME,GLD,GOOGL,HOOD,HYG,INTC,JPM,KRE,LLY,MARA,META,MRVL,MSFT,MSTR,MU,NFLX,NKE,NVDA,ORCL,PANW,PDD,PLTR,PYPL,QCOM,RIVN,RKLB,SHOP,SLV,SMCI,SMH,SOFI,SPCX,TLT,TSM,TSLA,UBER,UNH,USO,WMT,XLE,XLF}"
