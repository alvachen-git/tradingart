...
US_OPTIONS_UNDERLYINGS="${US_OPTIONS_UNDERLYINGS:-SPY,QQQ,DIA,IWM,AAPL,AMD,AMZN,AVGO,BABA,BAC,COIN,DIS,GLD,GOOGL,HOOD,HYG,INTC,JPM,MARA,META,MSFT,MSTR,MU,NFLX,NVDA,PLTR,RIVN,SLV,SMCI,SOFI,TLT,TSM,TSLA,UBER,WMT,XLE,XLF}"
