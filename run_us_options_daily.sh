...
US_OPTIONS_UNDERLYINGS="${US_OPTIONS_UNDERLYINGS:-SPY,QQQ,DIA,IWM,AAPL,ADBE,AMD,AMZN,APP,ARM,ASML,AVGO,BA,BABA,BAC,C,CAT,COIN,CRM,CRWD,CVNA,DELL,DIS,DRAM,EEM,F,FXI,GME,GLD,GOOGL,HOOD,HYG,IBM,INTC,JPM,KRE,LLY,MARA,META,MRVL,MSFT,MSTR,MU,NFLX,NKE,NVDA,ORCL,PANW,PDD,PFE,PLTR,PYPL,QCOM,RIVN,RKLB,SHOP,SLV,SMCI,SMH,SNOW,SOFI,SPCX,TLT,TSM,TSLA,UBER,UNH,USO,VRT,WFC,WMT,XBI,XLE,XLF,XLI,XLK,XLV,XLY}"
...
US_OPTIONS_PROFILE_CACHE_ENABLED="${US_OPTIONS_PROFILE_CACHE_ENABLED:-0}"
