...
US_OPTIONS_UNDERLYINGS="${US_OPTIONS_UNDERLYINGS:-SPY,QQQ,DIA,IWM,AAPL,AMD,AMZN,ARM,ASML,AVGO,BABA,BAC,COIN,CRWD,DELL,DIS,DRAM,GLD,GOOGL,HOOD,HYG,INTC,JPM,MARA,META,MRVL,MSFT,MSTR,MU,NFLX,NKE,NVDA,ORCL,PLTR,QCOM,RIVN,RKLB,SLV,SMCI,SOFI,SPCX,TLT,TSM,TSLA,UBER,WMT,XLE,XLF}"
