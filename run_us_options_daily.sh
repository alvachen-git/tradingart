...
US_OPTIONS_UNDERLYINGS="${US_OPTIONS_UNDERLYINGS:-SPY,QQQ,DIA,IWM,AAPL,AMD,AMZN,AVGO,COIN,GLD,GOOGL,HOOD,HYG,INTC,META,MSFT,MSTR,NFLX,NVDA,PLTR,SLV,SMCI,TLT,TSM,TSLA,XLE,XLF}"
